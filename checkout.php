...
<main class="checkout">
    <div class="container checkout-grid">
        <section class="checkout-form">
            <h1>Inscrição</h1>
            <p class="muted">Preencha os dados abaixo. Após a confirmação, você será direcionado ao pagamento.</p>
            ...
            <form id="form-inscricao" novalidate>
                ...
                <fieldset>
                    ...
                    <div id="bloco-cartao" hidden>
                        ...
                        <label>Parcelas
                            ...
                            <small class="muted">A taxa do cartão é repassada ao participante. O pagamento via PIX não possui taxa.</small>
                        </label>
                    </div>
                </fieldset>
                ...
                <p class="terms">Ao concluir a inscrição, você declara estar de acordo com os termos do evento. Pagamento processado pela Asaas.</p>
            </form>
        </section>
